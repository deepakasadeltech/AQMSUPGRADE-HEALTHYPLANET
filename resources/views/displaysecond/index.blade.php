...
<?php	
	...
	?>
	  ...
	  <div class="boxrow2" class="caption right-align">
       ...
       <div style="display:none;" class="cstring">{{ substr($settings->name, 0, 44) }}</div>     
               <div class="queuelogo displaylogo">
               <span><img src="{{url('public/logo')}}/{{ $settings->logo }}" alt="logo"></span> <span><strong class="first"></strong> <strong class="second"></strong> <strong class="third"></strong></span>
                </div>
            </div>
     ...
     @if($d2[0]['doctor_photo'] !== NULL)<img src="{{url('public/doctorimg')}}/{{ $d2[0]['doctor_photo'] }}" alt="User Photo"> 
    ...
    @if($d2[0]['ads_img'] !== NULL)<img src="{{url('public/adsimg')}}/{{ $d2[0]['ads_img'] }}" alt="User Photo"> 
     @else <img src="{{url('public/adsimg')}}/avatar.jpg" alt="Default Image" > @endif
    </div>
        </div>
       ...
       <!------End-adv-img---------->
		...
		<th><span class="spth">{{ trans('messages.display.dtoken') }}</span></th>
		<th><span class="spth">{{ trans('messages.display.roomnumber') }}</span></th>
		</tr>
		</thead>
		<tbody>
...
<!----------------------------------------------->
    ...
    <div style="display:none;" class="option">
        ...
        <option selected value="Google हिन्दी">{{ $settings->language->display }}</option>
        </select>
	</div>
