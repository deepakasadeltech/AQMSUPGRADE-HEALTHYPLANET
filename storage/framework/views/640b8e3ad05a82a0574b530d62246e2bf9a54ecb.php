         ...
         <!------------------------------------------>
            ...
            <!-------check-reg-validation------------->
             ...
             <!----Name-Mobile-Email---------> 
                ...
                <div class="col s4"><input class="pmobile_<?php echo e($activedoctor->id); ?>" name="pmobile" type="number" placeholder="Patient Mobile No" value="" autocomplete="off" />  </div>
...
<!--------=========Start-Token-Department-Wise============-------------------------->
             ...
             <!---------------------------------------->
                ...
                <div class="col s4"><input class="pmobile_<?php echo e($department->id); ?>" name="pmobile" type="number" placeholder="Patient Mobile No" value="" autocomplete="off" />  </div>
                <div class="col s4"><input class="pemail_<?php echo e($department->id); ?>" name="pemail" type="email" placeholder="Patient Email Address" value="" autocomplete="off" />  </div>
                </div>
             <!------------------------------->
                </form>
                <div class="modal-footer">
