                ...
                <form id="add" action="<?php echo e(route('departments.store')); ?>" method="post">
                    ...
                    <div class="row">
                        <div class="input-field col s12">
                            ...
                            <input id="olangname" type="text" name="olangname" placeholder="<?php echo e(trans('messages.mainapp.menu.subdept_otherlanguage')); ?>" value="<?php echo e(old('olangname')); ?>" data-error=".olangname">
                            <div class="olangname">
