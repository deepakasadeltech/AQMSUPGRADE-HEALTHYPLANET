        ...
        <div class="row">
            <div class="col s12 m6">
                <div class="card">
                    <div class="card-content">
                        ...
                        <!--------------------->
                        <form enctype="multipart/form-data" id="photoimg" action="<?php echo e(route('user_photo')); ?>" method="post">
                            <?php echo e(csrf_field()); ?>

                        <div class="row" style="position:relative;">
            <div class="input-field col s12" style="margin-bottom:30px; padding-bottom:10px; border-bottom: 1px solid #9e9e9e;">
            <span style="display:block;font-size:.8rem;color:#9e9e9e; margin-bottom:10px;"> Photo (size:200px * 230px) <?php if($errors->has('photo')): ?> <strong style="color:red">Please check image dimension (200px * 230px)</strong> <?php endif; ?></span>
            <input id="photo" type="file" name="photo" value="<?php echo e($user->photo); ?>"> 
            <button class="photoupdatebtn" type="submit"> Photo <?php echo e(trans('messages.update')); ?><i class="mdi-action-swap-vert left"></i> </button>              
            </div>
            <div class="userphoto"> <?php if($user->photo !== NULL): ?><img src="<?php echo e(url('public/doctorimg')); ?>/<?php echo e($user->photo); ?>"> 
                                    <?php else: ?> <img src="<?php echo e(url('public/doctorimg')); ?>/avatar.jpg"> <?php endif; ?> </div>             
            </div>
            ...
            <div class="row">
                        <div class="input-field col s12">
                            ...
                            <input id="profile" type="text" name="profile" placeholder="Profile Name" value="<?php echo e($user->profile); ?>" data-error=".profile">
                            <div class="profile">
                                <?php if($errors->has('profile')): ?><div class="error"><?php echo e($errors->first('profile')); ?></div><?php endif; ?>
                            </div>
                        </div>
                    </div>
                          <!---------------------> 
                            <div class="row">
                                <div class="input-field col s12">
                                    ...
                                    <input id="username" type="text" name="username" placeholder="<?php echo e(trans('messages.users.username')); ?>" value="<?php echo e($user->username); ?>" data-error=".username" readonly>
                                    <div class="username">
                ...
                <div class="col s12 m6">
                    <div class="card">
                        <div class="card-content">
                            ...
                            <div class="divider" style="margin:10px 0 10px 0"></div>
                        <!-------------------------------->    
                        <form enctype="multipart/form-data" id="clogo" action="<?php echo e(route('update_clogo')); ?>" method="post" >
            <?php echo e(csrf_field()); ?>

             <div class="row">
             <div class="input-field col s12">
             <span style="display:block; margin-bottom:10px;">Logo (size=233px*227px) <?php if($errors->has('logo')): ?> <strong style="color:red">Please check image dimension (233px * 227px)</strong> <?php endif; ?></span>
             <input id="logo" type="file" name="logo" value="<?php echo e($settings->logo); ?>">
             <button class="btn waves-effect waves-light right" type="submit">
            <?php echo e(trans('messages.update')); ?><i class="mdi-action-swap-vert left"></i></button>
             <div style="width:100px; margin: auto"> <img style="max-width:100%" src="<?php echo e(url('public/logo')); ?>/<?php echo e($settings->logo); ?>" > </div>               
            </div>
            </div>
